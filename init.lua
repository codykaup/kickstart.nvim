...
-- Vim keymaps
vim.keymap.set('n', '<leader>gs', ':tab Git<CR>', { desc = '[G]it [S]tatus' })
vim.keymap.set('n', '<leader>gc', ":Git commit -m ''<left>", { desc = '[G]it [C]ommit' })
vim.keymap.set('n', '<leader>gb', ':Git blame<CR><C-w>l', { desc = '[G]it [B]lame' })
...
-- Go: Handle auto formatting and imports
...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      require('which-key').setup { triggers_nowait = {} }
...

  {
    ...
    config = function()
      vim.keymap.set('n', '<space>fb', ':Telescope file_browser path=%:p:h select_buffer=true<CR>', { desc = 'File [B]rowser' })
    end,
  },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sn', function()
        require('telescope').extensions.smart_open.smart_open { cwd_only = true, cwd = vim.fn.stdpath 'config' }
